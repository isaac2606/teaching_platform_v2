...
const CourseCard = memo(function CourseCard({ hub, onDelete, onEdit }) {
    const [isEditing, setIsEditing] = useState(false);
    const [editValue, setEditValue] = useState("");

    return(
        <div className="relative glass-panel group overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-brand-primary/20 hover:-translate-y-1">
            ...
            <div className="relative p-6 flex flex-col h-48 justify-between">
                ...
                <div className="flex justify-center mt-auto w-full">
                    <Link to={`/teacherFeed/${hub.id}`} className="w-full">
